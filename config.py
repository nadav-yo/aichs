...
# Left activity panel (nav column + stack: sessions, files, git).
ACTIVITY_NAV_WIDTH = 200
ACTIVITY_RAIL_WIDTH = ACTIVITY_NAV_WIDTH  # legacy alias
MIN_ACTIVITY_WIDTH = 440
DEFAULT_ACTIVITY_WIDTH = 520
MAX_ACTIVITY_WIDTH = 720
ACTIVITY_STACK_MIN_WIDTH = MIN_ACTIVITY_WIDTH - ACTIVITY_NAV_WIDTH
